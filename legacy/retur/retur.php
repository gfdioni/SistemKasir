...
<form name="retur" method="post" onsubmit="return validate_form()" action="?page=retur"> <?php
		...
		<table>
			<tr>
				...
				<input type="hidden" name="no_faktur" value="<? echo $no_faktur;?>" />
			</tr>
			<tr>
				<td>Tgl Faktur</td>
				<td>:</td>
	...
	<br />Masukkan item obat yang akan di retur : <input type="text" name="jumlah" value="<? echo $jumlah; ?>" autocomplete="off" />
