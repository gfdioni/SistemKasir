...
<form action="?page=pemesanan_insert" method="post" name="pesan" onsubmit="return validate_form()">
<table border="0">
	<tr>
		<td>Pilih PBF</td>
		<td>:</td>
	...
	<tr>
		...
		<td>:</td>
		<td><input type="text" name="jumlah" value="<?php echo $jumlah; ?>" autofocus autocomplete="off"/></td>
	</tr>
	<tr>
		<td></td>
		<td></td>
