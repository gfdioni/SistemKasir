<h5>Halaman Laporan Stok Obat di Etalase</h5>
...
<form method="post" action="?page=stok_view_etalase">
Masukkan Nama Obat : <input type="text" name="cari" autocomplete="off" autofocus>
<input type="submit" name="submit" value="CARI"><br>
</form>

<br /><h5>Warna Kuning Artinya Stok Sekarang dibawah Stok Minimum Etalase</h5><br />
...
<table border='1'>
	<tr align='center' bgcolor='cyan'>
		...
		<td width='80'>Stok Etalase Sekarang</td>
	</tr>
<?php	
...
$query="SELECT O.KODE_OBAT, NAMA_OBAT, SATUAN, HARGA, HARGA_LANGGANAN, SUM(STOK) FROM OBAT O, ETALASE E WHERE O.KODE_OBAT=E.KODE_OBAT and (O.NAMA_OBAT LIKE '%$cari%' or O.KODE_OBAT LIKE '%$cari%') GROUP BY KODE_OBAT ORDER BY NAMA_OBAT ASC";
	...
	<tr align='center'> 
        ...
        //ambil stok minimum
        $query_stok_min    = "select stok_min_etalase from obat where kode_obat='$data[0]'";
        ...
        if ($sekarang < $hasil_stok_min) {
            ?>
				<td width="100" align="center" bgcolor="yellow"><?php echo $data[5]; ?></td><?php
