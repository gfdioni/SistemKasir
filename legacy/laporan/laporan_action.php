...
<br/>
<h2 align='center'><a href="#" onclick="MM_openBrWindow('export/laporan.php?pilihan=<? echo $pilihan; ?>&bulan=<? echo $bulan; ?>&tahun=<? echo $tahun;?>','','width=400,height=400')">Export</a>
</h2>
